...
const FormList = () => {
  ...
  const handleDragDrop = (results: DropResult) => {
    ...
    const newFormList = [...formList.forms];
    const [removed] = newFormList.splice(source.index, 1);
    newFormList.splice(destination.index, 0, removed);
    setFormList({ ...formList, forms: newFormList });
  };
    ...
    <div>
      <div className="flex flex-col gap-5 p-4 max-h-96 overflow-y-auto">
        ...
        <DragDropContext onDragEnd={handleDragDrop}>
          <StrictModeDroppable droppableId="formlist">
            {(provided) => (
              <div
                id="formlist"
